  ...
  return (
    <div className='flex flex-col justify-center items-center gap-10 mt-16 mb-16'>
        ...
        <div className='grid grid-cols-2 xl:grid-cols-3 lg:grid-cols-3 gap-14'>
            <i className='bg-blue-700 hover:bg-amber-500 p-5 text-center cursor-pointer text-white border hover:scale-110 transition-all'>Adopen</i>
            <i className='bg-blue-700 hover:bg-amber-500 p-5 text-center cursor-pointer text-white border rounded hover:scale-110 transition-all'>Alfapen</i>
