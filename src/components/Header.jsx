...
function Header() {
  return (
    <div className="bg-blue-700 px-5 flex justify-center xl:justify-between md:justify-between items-center">
        <div className='xl:bg-yellow-400 md:bg-yellow-400 xl:p-5 md:p-5 xl:shadow-xl md:shadow-xl p-3 grid xl:grid-rows-2 md:grid-rows-2'>
        ...
        <div className="xl:flex md:flex hidden justify-center items-center gap-4">
            ...
            <i className='text-white hover:text-red-600'>+90(545) 619 1982</i>
            <div className='p-4 rounded-full text-3xl text-white hover:text-white hover:cursor-pointer'>
                <FaInstagram />
            </div>
        </div>
